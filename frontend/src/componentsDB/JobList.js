      ...
      <table>
        ...
        {jobs && 
                    ...
                    return(
                        ...
                        <td><button className="secondary" onClick={(e)=> handleEdit(e, job.id)}>Edit</button></td>
                        <td><button className="negative" onClick={(e) => handleDelete(e, job.id)}>Delete</button></td>
                    </tr>
